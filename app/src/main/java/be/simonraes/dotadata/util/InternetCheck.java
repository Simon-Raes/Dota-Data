...
public class InternetCheck {
    ...
    public static boolean serviceAvailable(Context context) {
        ...
        try {
            httpRequest = new HttpGet(new URI("https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key=" + AppPreferences.getApiKey(context) + "&account_id=6133547"));
    ...
    public static boolean siteAvailable(Context context) {
        try {
            Socket socket = new Socket();
            SocketAddress socketAddress = new InetSocketAddress("https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key=" + AppPreferences.getApiKey(context) + "&account_id=6133547", 80);
