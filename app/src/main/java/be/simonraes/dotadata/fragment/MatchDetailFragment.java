...
//        System.out.println("MatchDetailFragment oncreateview");
        ...
        //todo: split some of these off to fragments and/or background loading if possible
        setHeader();
        setNote();
        scrollScoreboard();
        setScoreboard();
...
//        System.out.println("MatchdetailFragment setscoreboard");
        ...
        if (numberOfRadiantPlayers == 0) {
            layPlayersRadiant.setVisibility(View.GONE);
        }

        if (numberOfDirePlayers == 0) {
