...
public class DetailMatchParser extends AsyncTask<String, Void, DetailContainer> {
    ...
    public DetailMatchParser(Context context, ASyncResponseDetail delegate) {
    ...
    protected DetailContainer doInBackground(String... params) {
        ...
        try {
            container = mapper.readValue(new URL("https://api.steampowered.com/IDOTA2Match_570/GetMatchDetails/V001/?key=" + AppPreferences.getApiKey(context) + "&match_id=" + matchid), DetailContainer.class);
