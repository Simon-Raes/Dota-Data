...
public class HistoryMatchParser extends AsyncTask<String, Void, HistoryContainer> {
    ...
    public HistoryMatchParser(Context context, ASyncResponseHistory delegate) {
    ...
    protected HistoryContainer doInBackground(String... params) {
        ...
        String parseURL = "https://api.steampowered.com/IDOTA2Match_570/GetMatchHistory/V001/?key="+ AppPreferences.getApiKey(context)+"&account_id=" + accountID;
